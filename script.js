...
const traitToType = {
  // Popular
  "Animated: Full of life, lively use of hand, arm, and face gestures.": "Popular",
  "Playful: Full of fun and good humor.": "Popular",
  "Sociable: One who sees being with others as an opportunity to be cute and entertaining rather than as a challenge or business opportunity.": "Popular",
  "Convincing: Can win you over to anything through the sheer charm of his personality.": "Popular",
  "Spirited: Full of life and excitement.": "Popular",
  "Promoter: Urges or compels others to go along, join, or invest through the charm of his own personality.": "Popular",
  "Spontaneous: Prefers all of life to be an impulsive, unpremeditated activity, not restricted by plans.": "Popular",
  "Optimistic: Sunny disposition who convinces himself and others that everything will turn out all right.": "Popular",
  "Funny: Sparkling sense of humor that can make virtually any story into a hilarious event.": "Popular",
  "Refreshing: Renews and stimulates or makes others feel good.": "Popular",
  "Delightful: A person who is upbeat and fun to be with.": "Popular",
  "Cheerful: Consistently in good spirits and promoting happiness in others.": "Popular",
  "Inspiring: Encourages others to work, join, or be involved, and makes the whole thing fun.": "Popular",
  "Demonstrative: Openly expresses emotion, especially affection, and doesn't hesitate to touch others while speaking to them.": "Popular",
  "Mixes easily: Loves a party and can't wait to meet everyone in the room, never meets a stranger.": "Popular",
  "Talker: Constantly talking, generally telling funny stories and entertaining everyone around, feeling the need to fill the silence in order to make others comfortable.": "Popular",
  "Lively: Full of life, vigorous, energetic.": "Popular",
  "Cute: Precious, adorable, center of attention.": "Popular",
  "Popular: Life of the party and therefore much desired as a party guest.": "Popular",
  "Bouncy: A bubbly, lively personality, full of energy.": "Popular",

  // Powerful
  "Adventurous: One who will take on new and daring enterprises with a determination to master them.": "Powerful",
  "Persuasive: Convinces through logic and fact rather than charm or power.": "Powerful",
  "Strong-willed: One who is determined to have his own way.": "Powerful",
  "Competitive: Turns every situation, happening, or game into a contest and always plays to win!": "Powerful",
  "Self-reliant: An independent person who can fully rely on his own capabilities, judgment, and resources.": "Powerful",
  "Positive: Knows it will turn out right if he's in charge.": "Powerful",
  "Sure: Confidence, rarely hesitates or wavers.": "Powerful",
  "Outspoken: Speaks frankly and without reserve.": "Powerful",
  "Resourceful: Able to act quickly and effectively in virtually all situations.": "Powerful",
  "Daring: Willing to take risks; fearless, bold.": "Powerful",
  "Confident: Self-assured and certain of own ability and success.": "Powerful",
  "Independent: Self-sufficient, self-supporting, self-confident, and seems to have little need of help.": "Powerful",
  "Decisive: A person with quick, conclusive, judgment-making ability.": "Powerful",
  "Tenacious: Holds on firmly, stubbornly, and won't let go until the goal is accomplished.": "Powerful",
  "Leader: A natural-born director, who is driven to be in charge, and often finds it difficult to believe that anyone else can do the job as well.": "Powerful",
  "Chief: Commands leadership and expects people to follow.": "Powerful",
  "Mover: Driven by a need to be productive, is a leader whom others follow, finds it difficult to sit still.": "Powerful",
  "Productive: Must constantly be working or achieving, often finds it very difficult to rest.": "Powerful",
  "Bold: Fearless, daring, forward, unafraid of risk.": "Powerful",

  // Perfect
  "Analytical: Likes to examine the parts for their logical and proper relationships.": "Perfect",
  "Persistent: Sees one project through to its completion before starting another.": "Perfect",
  "Self-sacrificing: Willingly gives up his own personal being for the sake of, or to meet the needs of others.": "Perfect",
  "Considerate: Having regard for the needs and feelings of others.": "Perfect",
  "Sensitive: Intensively cares about others, and what happens.": "Perfect",
  "Planner: Prefers to work out a detailed arrangement beforehand for the accomplishment of a project or goal, and prefers involvement with the planning stages and the finished product rather than the carrying out of the task.": "Perfect",
  "Schedule: Makes, and lives, according to a daily plan, and dislikes his plan to be interrupted.": "Perfect",
  "Orderly: A person who has a methodical, systematic arrangement of things.": "Perfect",
  "Faithful: Consistently reliable, steadfast, loyal, and devoted sometimes beyond reason.": "Perfect",
  "Respectful: Treats others with deference, honor, and esteem.": "Perfect",
  "Detailed: Does everything in proper order with a clear memory of all the things that happen.": "Perfect",
  "Cultured: One whose interests involve both intellectual and artistic pursuits, such as theater, symphony, and ballet.": "Perfect",
  "Idealistic: Visualizes things in their perfect form, and has a need to measure up to that standard himself.": "Perfect",
  "Deep: Intense and often introspective with a distaste for surface conversation and pursuits.": "Perfect",
  "Musical: Participates in or has a deep appreciation for music, is committed to music as an art form, rather than the fun of performance.": "Perfect",
  "Thoughtful: A considerate person who remembers special occasions and is quick to make a kind gesture.": "Perfect",
  "Loyal: Faithful to a person, ideal, or job, sometimes beyond reason.": "Perfect",
  "Chart maker: Organizes life, tasks, and problem-solving by making lists, forms, or graphs.": "Perfect",
  "Perfectionist: Places high standards on himself, and often on others, desiring that everything be in proper order at all times.": "Perfect",
  "Behaved: Consistently desires to conduct himself within the realm of what he feels is proper.": "Perfect",

  // Peaceful
  "Adaptable: Easily fits and is comfortable in any situation.": "Peaceful",
  "Peaceful: Seems undisturbed and tranquil and retreats from any form of strife.": "Peaceful",
  "Submissive: Easily accepts any other's point of view or desire with little need to assert his own opinion.": "Peaceful",
  "Controlled: Has emotional feelings but rarely displays them.": "Peaceful",
  "Satisfied: A person who easily accepts any circumstance or situation.": "Peaceful",
  "Patient: Unmoved by delay, remains calm and tolerant.": "Peaceful",
  "Shy: Quiet, doesn't easily instigate a conversation.": "Peaceful",
  "Obliging: Accommodating. One who is quick to do it another's way.": "Peaceful",
  "Reserved: Self-restraint in the expression of emotion or enthusiasm.": "Peaceful",
  "Diplomatic: Deals with people tactfully, sensitively, and patiently.": "Peaceful",
  "Consistent: Stays emotionally on an even keel, responding as one might expect.": "Peaceful",
  "Inoffensive: A person who never says or causes anything unpleasant or objectionable.": "Peaceful",
  "Dry humor: Exhibits 'dry wit,' usually one-liners which can be sarcastic in nature.": "Peaceful",
  "Mediator: Consistently finds himself or herself in the role of reconciling differences in order to avoid conflict.": "Peaceful",
  "Tolerant: Easily accepts the thoughts and ways of others without the need to disagree with or change them.": "Peaceful",
  "Listener: Always seems willing to hear what you have to say.": "Peaceful",
  "Contented: Easily satisfied with what he has, rarely envious.": "Peaceful",
  "Pleasant: Easygoing, easy to be around, easy to talk with.": "Peaceful",
  "Balanced: Stable, middle-of-the-road personality, not subject to sharp highs or lows.": "Peaceful"
};
